  ...
  <div class="block">
    <div v-loading="!loginStatus" class="card">
      <div v-if="loginStatus==-1">
        ...
        <div v-loading="!imgBase64"
             style="width: 150px;height: 150px;margin-top: 5px;margin-left: auto;margin-right: auto;">
      ...
      <div v-if="loginStatus==-2">
        ...
        <el-input v-model="bindQQ" placeholder="请输入QQ号"
                  style="margin-top: 5px;margin-left: auto;margin-right: auto;"/>
        <br>
        <br>
        <el-button class='action warn' type="warning" @click="bindQQFunc">点击验证</el-button>
        <br>
